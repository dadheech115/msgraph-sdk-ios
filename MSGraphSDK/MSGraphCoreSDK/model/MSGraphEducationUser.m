...
- (NSArray*) relatedContacts
{
    ...
    if ([relatedContacts isKindOfClass:[NSArray class]]){
        for (id educationRelatedContact in relatedContacts){
            [relatedContactsResult addObject:[[MSGraphEducationRelatedContact alloc] initWithDictionary: educationRelatedContact]];
        }
    }
...
- (NSArray*) schools
{
    ...
    if ([schools isKindOfClass:[NSArray class]]){
        for (id educationSchool in schools){
            [schoolsResult addObject:[[MSGraphEducationSchool alloc] initWithDictionary: educationSchool]];
        }
    }
...
- (NSArray*) classes
{
    ...
    if ([classes isKindOfClass:[NSArray class]]){
        for (id educationClass in classes){
            [classesResult addObject:[[MSGraphEducationClass alloc] initWithDictionary: educationClass]];
        }
    }
