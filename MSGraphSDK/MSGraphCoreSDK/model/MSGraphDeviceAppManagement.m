...
- (NSArray*) mobileApps
{
    ...
    if ([mobileApps isKindOfClass:[NSArray class]]){
        for (id mobileApp in mobileApps){
            [mobileAppsResult addObject:[[MSGraphMobileApp alloc] initWithDictionary: mobileApp]];
        }
    }
...
- (NSArray*) mobileAppCategories
{
    ...
    if ([mobileAppCategories isKindOfClass:[NSArray class]]){
        for (id mobileAppCategory in mobileAppCategories){
            [mobileAppCategoriesResult addObject:[[MSGraphMobileAppCategory alloc] initWithDictionary: mobileAppCategory]];
        }
    }
...
- (NSArray*) mobileAppConfigurations
{
    ...
    if ([mobileAppConfigurations isKindOfClass:[NSArray class]]){
        for (id managedDeviceMobileAppConfiguration in mobileAppConfigurations){
            [mobileAppConfigurationsResult addObject:[[MSGraphManagedDeviceMobileAppConfiguration alloc] initWithDictionary: managedDeviceMobileAppConfiguration]];
        }
    }
...
- (NSArray*) vppTokens
{
    ...
    if ([vppTokens isKindOfClass:[NSArray class]]){
        for (id vppToken in vppTokens){
            [vppTokensResult addObject:[[MSGraphVppToken alloc] initWithDictionary: vppToken]];
        }
    }
...
- (NSArray*) managedAppPolicies
{
    ...
    if ([managedAppPolicies isKindOfClass:[NSArray class]]){
        for (id managedAppPolicy in managedAppPolicies){
            [managedAppPoliciesResult addObject:[[MSGraphManagedAppPolicy alloc] initWithDictionary: managedAppPolicy]];
        }
    }
...
- (NSArray*) iosManagedAppProtections
{
    ...
    if ([iosManagedAppProtections isKindOfClass:[NSArray class]]){
        for (id iosManagedAppProtection in iosManagedAppProtections){
            [iosManagedAppProtectionsResult addObject:[[MSGraphIosManagedAppProtection alloc] initWithDictionary: iosManagedAppProtection]];
        }
    }
...
- (NSArray*) androidManagedAppProtections
{
    ...
    if ([androidManagedAppProtections isKindOfClass:[NSArray class]]){
        for (id androidManagedAppProtection in androidManagedAppProtections){
            [androidManagedAppProtectionsResult addObject:[[MSGraphAndroidManagedAppProtection alloc] initWithDictionary: androidManagedAppProtection]];
        }
    }
...
- (NSArray*) defaultManagedAppProtections
{
    ...
    if ([defaultManagedAppProtections isKindOfClass:[NSArray class]]){
        for (id defaultManagedAppProtection in defaultManagedAppProtections){
            [defaultManagedAppProtectionsResult addObject:[[MSGraphDefaultManagedAppProtection alloc] initWithDictionary: defaultManagedAppProtection]];
        }
    }
...
- (NSArray*) targetedManagedAppConfigurations
{
    ...
    if ([targetedManagedAppConfigurations isKindOfClass:[NSArray class]]){
        for (id targetedManagedAppConfiguration in targetedManagedAppConfigurations){
            [targetedManagedAppConfigurationsResult addObject:[[MSGraphTargetedManagedAppConfiguration alloc] initWithDictionary: targetedManagedAppConfiguration]];
        }
    }
...
- (NSArray*) mdmWindowsInformationProtectionPolicies
{
    ...
    if ([mdmWindowsInformationProtectionPolicies isKindOfClass:[NSArray class]]){
        for (id mdmWindowsInformationProtectionPolicy in mdmWindowsInformationProtectionPolicies){
            [mdmWindowsInformationProtectionPoliciesResult addObject:[[MSGraphMdmWindowsInformationProtectionPolicy alloc] initWithDictionary: mdmWindowsInformationProtectionPolicy]];
        }
    }
...
- (NSArray*) windowsInformationProtectionPolicies
{
    ...
    if ([windowsInformationProtectionPolicies isKindOfClass:[NSArray class]]){
        for (id windowsInformationProtectionPolicy in windowsInformationProtectionPolicies){
            [windowsInformationProtectionPoliciesResult addObject:[[MSGraphWindowsInformationProtectionPolicy alloc] initWithDictionary: windowsInformationProtectionPolicy]];
        }
    }
...
- (NSArray*) managedAppRegistrations
{
    ...
    if ([managedAppRegistrations isKindOfClass:[NSArray class]]){
        for (id managedAppRegistration in managedAppRegistrations){
            [managedAppRegistrationsResult addObject:[[MSGraphManagedAppRegistration alloc] initWithDictionary: managedAppRegistration]];
        }
    }
...
- (NSArray*) managedAppStatuses
{
    ...
    if ([managedAppStatuses isKindOfClass:[NSArray class]]){
        for (id managedAppStatus in managedAppStatuses){
            [managedAppStatusesResult addObject:[[MSGraphManagedAppStatus alloc] initWithDictionary: managedAppStatus]];
        }
    }
...
- (NSArray*) managedEBooks
{
    ...
    if ([managedEBooks isKindOfClass:[NSArray class]]){
        for (id managedEBook in managedEBooks){
            [managedEBooksResult addObject:[[MSGraphManagedEBook alloc] initWithDictionary: managedEBook]];
        }
    }
