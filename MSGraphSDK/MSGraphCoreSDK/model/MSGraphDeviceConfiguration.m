...
- (NSArray*) assignments
{
    ...
    if ([assignments isKindOfClass:[NSArray class]]){
        for (id deviceConfigurationAssignment in assignments){
            [assignmentsResult addObject:[[MSGraphDeviceConfigurationAssignment alloc] initWithDictionary: deviceConfigurationAssignment]];
        }
    }
...
- (NSArray*) deviceStatuses
{
    ...
    if ([deviceStatuses isKindOfClass:[NSArray class]]){
        for (id deviceConfigurationDeviceStatus in deviceStatuses){
            [deviceStatusesResult addObject:[[MSGraphDeviceConfigurationDeviceStatus alloc] initWithDictionary: deviceConfigurationDeviceStatus]];
        }
    }
...
- (NSArray*) userStatuses
{
    ...
    if ([userStatuses isKindOfClass:[NSArray class]]){
        for (id deviceConfigurationUserStatus in userStatuses){
            [userStatusesResult addObject:[[MSGraphDeviceConfigurationUserStatus alloc] initWithDictionary: deviceConfigurationUserStatus]];
        }
    }
