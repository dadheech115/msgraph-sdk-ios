...
- (NSArray*) configurationDeploymentSummaryPerApp
{
    ...
    if ([configurationDeploymentSummaryPerApp isKindOfClass:[NSArray class]]){
        for (id managedAppPolicyDeploymentSummaryPerApp in configurationDeploymentSummaryPerApp){
            [configurationDeploymentSummaryPerAppResult addObject:[[MSGraphManagedAppPolicyDeploymentSummaryPerApp alloc] initWithDictionary: managedAppPolicyDeploymentSummaryPerApp]];
        }
    }
