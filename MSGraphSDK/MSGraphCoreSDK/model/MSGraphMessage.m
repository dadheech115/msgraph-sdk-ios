...
- (NSArray*) internetMessageHeaders
{
    ...
    if ([internetMessageHeaders isKindOfClass:[NSArray class]]){
        for (id internetMessageHeader in internetMessageHeaders){
            [internetMessageHeadersResult addObject:[[MSGraphInternetMessageHeader alloc] initWithDictionary: internetMessageHeader]];
        }
    }
