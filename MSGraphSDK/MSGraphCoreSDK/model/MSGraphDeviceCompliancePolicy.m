...
- (NSArray*) scheduledActionsForRule
{
    ...
    if ([scheduledActionsForRule isKindOfClass:[NSArray class]]){
        for (id deviceComplianceScheduledActionForRule in scheduledActionsForRule){
            [scheduledActionsForRuleResult addObject:[[MSGraphDeviceComplianceScheduledActionForRule alloc] initWithDictionary: deviceComplianceScheduledActionForRule]];
        }
    }
...
- (NSArray*) deviceStatuses
{
    ...
    if ([deviceStatuses isKindOfClass:[NSArray class]]){
        for (id deviceComplianceDeviceStatus in deviceStatuses){
            [deviceStatusesResult addObject:[[MSGraphDeviceComplianceDeviceStatus alloc] initWithDictionary: deviceComplianceDeviceStatus]];
        }
    }
...
- (NSArray*) userStatuses
{
    ...
    if ([userStatuses isKindOfClass:[NSArray class]]){
        for (id deviceComplianceUserStatus in userStatuses){
            [userStatusesResult addObject:[[MSGraphDeviceComplianceUserStatus alloc] initWithDictionary: deviceComplianceUserStatus]];
        }
    }
...
- (NSArray*) deviceSettingStateSummaries
{
    ...
    if ([deviceSettingStateSummaries isKindOfClass:[NSArray class]]){
        for (id settingStateDeviceSummary in deviceSettingStateSummaries){
            [deviceSettingStateSummariesResult addObject:[[MSGraphSettingStateDeviceSummary alloc] initWithDictionary: settingStateDeviceSummary]];
        }
    }
...
- (NSArray*) assignments
{
    ...
    if ([assignments isKindOfClass:[NSArray class]]){
        for (id deviceCompliancePolicyAssignment in assignments){
            [assignmentsResult addObject:[[MSGraphDeviceCompliancePolicyAssignment alloc] initWithDictionary: deviceCompliancePolicyAssignment]];
        }
    }
