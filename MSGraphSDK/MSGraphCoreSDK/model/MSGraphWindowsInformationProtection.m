...
- (NSArray*) enterpriseProtectedDomainNames
{
    ...
    if ([enterpriseProtectedDomainNames isKindOfClass:[NSArray class]]){
        for (id windowsInformationProtectionResourceCollection in enterpriseProtectedDomainNames){
            [enterpriseProtectedDomainNamesResult addObject:[[MSGraphWindowsInformationProtectionResourceCollection alloc] initWithDictionary: windowsInformationProtectionResourceCollection]];
        }
    }
...
- (NSArray*) protectedApps
{
    ...
    if ([protectedApps isKindOfClass:[NSArray class]]){
        for (id windowsInformationProtectionApp in protectedApps){
            [protectedAppsResult addObject:[[MSGraphWindowsInformationProtectionApp alloc] initWithDictionary: windowsInformationProtectionApp]];
        }
    }
...
- (NSArray*) exemptApps
{
    ...
    if ([exemptApps isKindOfClass:[NSArray class]]){
        for (id windowsInformationProtectionApp in exemptApps){
            [exemptAppsResult addObject:[[MSGraphWindowsInformationProtectionApp alloc] initWithDictionary: windowsInformationProtectionApp]];
        }
    }
...
- (NSArray*) enterpriseNetworkDomainNames
{
    ...
    if ([enterpriseNetworkDomainNames isKindOfClass:[NSArray class]]){
        for (id windowsInformationProtectionResourceCollection in enterpriseNetworkDomainNames){
            [enterpriseNetworkDomainNamesResult addObject:[[MSGraphWindowsInformationProtectionResourceCollection alloc] initWithDictionary: windowsInformationProtectionResourceCollection]];
        }
    }
...
- (NSArray*) enterpriseProxiedDomains
{
    ...
    if ([enterpriseProxiedDomains isKindOfClass:[NSArray class]]){
        for (id windowsInformationProtectionProxiedDomainCollection in enterpriseProxiedDomains){
            [enterpriseProxiedDomainsResult addObject:[[MSGraphWindowsInformationProtectionProxiedDomainCollection alloc] initWithDictionary: windowsInformationProtectionProxiedDomainCollection]];
        }
    }
...
- (NSArray*) enterpriseIPRanges
{
    ...
    if ([enterpriseIPRanges isKindOfClass:[NSArray class]]){
        for (id windowsInformationProtectionIPRangeCollection in enterpriseIPRanges){
            [enterpriseIPRangesResult addObject:[[MSGraphWindowsInformationProtectionIPRangeCollection alloc] initWithDictionary: windowsInformationProtectionIPRangeCollection]];
        }
    }
...
- (NSArray*) enterpriseProxyServers
{
    ...
    if ([enterpriseProxyServers isKindOfClass:[NSArray class]]){
        for (id windowsInformationProtectionResourceCollection in enterpriseProxyServers){
            [enterpriseProxyServersResult addObject:[[MSGraphWindowsInformationProtectionResourceCollection alloc] initWithDictionary: windowsInformationProtectionResourceCollection]];
        }
    }
...
- (NSArray*) enterpriseInternalProxyServers
{
    ...
    if ([enterpriseInternalProxyServers isKindOfClass:[NSArray class]]){
        for (id windowsInformationProtectionResourceCollection in enterpriseInternalProxyServers){
            [enterpriseInternalProxyServersResult addObject:[[MSGraphWindowsInformationProtectionResourceCollection alloc] initWithDictionary: windowsInformationProtectionResourceCollection]];
        }
    }
...
- (NSArray*) neutralDomainResources
{
    ...
    if ([neutralDomainResources isKindOfClass:[NSArray class]]){
        for (id windowsInformationProtectionResourceCollection in neutralDomainResources){
            [neutralDomainResourcesResult addObject:[[MSGraphWindowsInformationProtectionResourceCollection alloc] initWithDictionary: windowsInformationProtectionResourceCollection]];
        }
    }
...
- (NSArray*) smbAutoEncryptedFileExtensions
{
    ...
    if ([smbAutoEncryptedFileExtensions isKindOfClass:[NSArray class]]){
        for (id windowsInformationProtectionResourceCollection in smbAutoEncryptedFileExtensions){
            [smbAutoEncryptedFileExtensionsResult addObject:[[MSGraphWindowsInformationProtectionResourceCollection alloc] initWithDictionary: windowsInformationProtectionResourceCollection]];
        }
    }
...
- (NSArray*) protectedAppLockerFiles
{
    ...
    if ([protectedAppLockerFiles isKindOfClass:[NSArray class]]){
        for (id windowsInformationProtectionAppLockerFile in protectedAppLockerFiles){
            [protectedAppLockerFilesResult addObject:[[MSGraphWindowsInformationProtectionAppLockerFile alloc] initWithDictionary: windowsInformationProtectionAppLockerFile]];
        }
    }
...
- (NSArray*) exemptAppLockerFiles
{
    ...
    if ([exemptAppLockerFiles isKindOfClass:[NSArray class]]){
        for (id windowsInformationProtectionAppLockerFile in exemptAppLockerFiles){
            [exemptAppLockerFilesResult addObject:[[MSGraphWindowsInformationProtectionAppLockerFile alloc] initWithDictionary: windowsInformationProtectionAppLockerFile]];
        }
    }
...
- (NSArray*) assignments
{
    ...
    if ([assignments isKindOfClass:[NSArray class]]){
        for (id targetedManagedAppPolicyAssignment in assignments){
            [assignmentsResult addObject:[[MSGraphTargetedManagedAppPolicyAssignment alloc] initWithDictionary: targetedManagedAppPolicyAssignment]];
        }
    }
