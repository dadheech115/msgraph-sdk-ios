...
- (NSArray*) settingStates
{
    ...
    if ([settingStates isKindOfClass:[NSArray class]]){
        for (id deviceConfigurationSettingState in settingStates){
            [settingStatesResult addObject:[[MSGraphDeviceConfigurationSettingState alloc] initWithDictionary: deviceConfigurationSettingState]];
        }
    }
