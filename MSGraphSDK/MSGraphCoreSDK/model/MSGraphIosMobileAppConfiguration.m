...
- (NSArray*) settings
{
    ...
    if ([settings isKindOfClass:[NSArray class]]){
        for (id appConfigurationSettingItem in settings){
            [settingsResult addObject:[[MSGraphAppConfigurationSettingItem alloc] initWithDictionary: appConfigurationSettingItem]];
        }
    }
