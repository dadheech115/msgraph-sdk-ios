...
- (NSArray*) forwardTo
{
    ...
    if ([forwardTo isKindOfClass:[NSArray class]]){
        for (id recipient in forwardTo){
            [forwardToResult addObject:[[MSGraphRecipient alloc] initWithDictionary: recipient]];
        }
    }
...
- (NSArray*) forwardAsAttachmentTo
{
    ...
    if ([forwardAsAttachmentTo isKindOfClass:[NSArray class]]){
        for (id recipient in forwardAsAttachmentTo){
            [forwardAsAttachmentToResult addObject:[[MSGraphRecipient alloc] initWithDictionary: recipient]];
        }
    }
...
- (NSArray*) redirectTo
{
    ...
    if ([redirectTo isKindOfClass:[NSArray class]]){
        for (id recipient in redirectTo){
            [redirectToResult addObject:[[MSGraphRecipient alloc] initWithDictionary: recipient]];
        }
    }
