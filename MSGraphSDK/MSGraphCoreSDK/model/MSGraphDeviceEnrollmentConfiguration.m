...
- (NSArray*) assignments
{
    ...
    if ([assignments isKindOfClass:[NSArray class]]){
        for (id enrollmentConfigurationAssignment in assignments){
            [assignmentsResult addObject:[[MSGraphEnrollmentConfigurationAssignment alloc] initWithDictionary: enrollmentConfigurationAssignment]];
        }
    }
