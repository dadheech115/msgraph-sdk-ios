...
- (NSArray*) appsSingleAppModeList
{
    ...
    if ([appsSingleAppModeList isKindOfClass:[NSArray class]]){
        for (id appListItem in appsSingleAppModeList){
            [appsSingleAppModeListResult addObject:[[MSGraphAppListItem alloc] initWithDictionary: appListItem]];
        }
    }
...
- (NSArray*) appsVisibilityList
{
    ...
    if ([appsVisibilityList isKindOfClass:[NSArray class]]){
        for (id appListItem in appsVisibilityList){
            [appsVisibilityListResult addObject:[[MSGraphAppListItem alloc] initWithDictionary: appListItem]];
        }
    }
...
- (NSArray*) networkUsageRules
{
    ...
    if ([networkUsageRules isKindOfClass:[NSArray class]]){
        for (id iosNetworkUsageRule in networkUsageRules){
            [networkUsageRulesResult addObject:[[MSGraphIosNetworkUsageRule alloc] initWithDictionary: iosNetworkUsageRule]];
        }
    }
