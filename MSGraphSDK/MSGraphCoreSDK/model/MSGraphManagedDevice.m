...
- (NSArray*) deviceActionResults
{
    ...
    if ([deviceActionResults isKindOfClass:[NSArray class]]){
        for (id deviceActionResult in deviceActionResults){
            [deviceActionResultsResult addObject:[[MSGraphDeviceActionResult alloc] initWithDictionary: deviceActionResult]];
        }
    }
...
- (NSArray*) deviceConfigurationStates
{
    ...
    if ([deviceConfigurationStates isKindOfClass:[NSArray class]]){
        for (id deviceConfigurationState in deviceConfigurationStates){
            [deviceConfigurationStatesResult addObject:[[MSGraphDeviceConfigurationState alloc] initWithDictionary: deviceConfigurationState]];
        }
    }
...
- (NSArray*) deviceCompliancePolicyStates
{
    ...
    if ([deviceCompliancePolicyStates isKindOfClass:[NSArray class]]){
        for (id deviceCompliancePolicyState in deviceCompliancePolicyStates){
            [deviceCompliancePolicyStatesResult addObject:[[MSGraphDeviceCompliancePolicyState alloc] initWithDictionary: deviceCompliancePolicyState]];
        }
    }
