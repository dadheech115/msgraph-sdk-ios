...
- (NSArray*) assignments
{
    ...
    if ([assignments isKindOfClass:[NSArray class]]){
        for (id managedEBookAssignment in assignments){
            [assignmentsResult addObject:[[MSGraphManagedEBookAssignment alloc] initWithDictionary: managedEBookAssignment]];
        }
    }
...
- (NSArray*) deviceStates
{
    ...
    if ([deviceStates isKindOfClass:[NSArray class]]){
        for (id deviceInstallState in deviceStates){
            [deviceStatesResult addObject:[[MSGraphDeviceInstallState alloc] initWithDictionary: deviceInstallState]];
        }
    }
...
- (NSArray*) userStateSummary
{
    ...
    if ([userStateSummary isKindOfClass:[NSArray class]]){
        for (id userInstallStateSummary in userStateSummary){
            [userStateSummaryResult addObject:[[MSGraphUserInstallStateSummary alloc] initWithDictionary: userInstallStateSummary]];
        }
    }
