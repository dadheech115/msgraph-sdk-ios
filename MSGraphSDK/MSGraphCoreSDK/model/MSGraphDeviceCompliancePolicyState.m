...
- (NSArray*) settingStates
{
    ...
    if ([settingStates isKindOfClass:[NSArray class]]){
        for (id deviceCompliancePolicySettingState in settingStates){
            [settingStatesResult addObject:[[MSGraphDeviceCompliancePolicySettingState alloc] initWithDictionary: deviceCompliancePolicySettingState]];
        }
    }
