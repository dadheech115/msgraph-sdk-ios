...
- (NSArray*) homeScreenDockIcons
{
    ...
    if ([homeScreenDockIcons isKindOfClass:[NSArray class]]){
        for (id iosHomeScreenItem in homeScreenDockIcons){
            [homeScreenDockIconsResult addObject:[[MSGraphIosHomeScreenItem alloc] initWithDictionary: iosHomeScreenItem]];
        }
    }
...
- (NSArray*) homeScreenPages
{
    ...
    if ([homeScreenPages isKindOfClass:[NSArray class]]){
        for (id iosHomeScreenPage in homeScreenPages){
            [homeScreenPagesResult addObject:[[MSGraphIosHomeScreenPage alloc] initWithDictionary: iosHomeScreenPage]];
        }
    }
...
- (NSArray*) notificationSettings
{
    ...
    if ([notificationSettings isKindOfClass:[NSArray class]]){
        for (id iosNotificationSettings in notificationSettings){
            [notificationSettingsResult addObject:[[MSGraphIosNotificationSettings alloc] initWithDictionary: iosNotificationSettings]];
        }
    }
