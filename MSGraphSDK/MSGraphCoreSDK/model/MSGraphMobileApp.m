...
- (NSArray*) categories
{
    ...
    if ([categories isKindOfClass:[NSArray class]]){
        for (id mobileAppCategory in categories){
            [categoriesResult addObject:[[MSGraphMobileAppCategory alloc] initWithDictionary: mobileAppCategory]];
        }
    }
...
- (NSArray*) assignments
{
    ...
    if ([assignments isKindOfClass:[NSArray class]]){
        for (id mobileAppAssignment in assignments){
            [assignmentsResult addObject:[[MSGraphMobileAppAssignment alloc] initWithDictionary: mobileAppAssignment]];
        }
    }
