...
- (NSArray*) members
{
    ...
    if ([members isKindOfClass:[NSArray class]]){
        for (id educationUser in members){
            [membersResult addObject:[[MSGraphEducationUser alloc] initWithDictionary: educationUser]];
        }
    }
...
- (NSArray*) teachers
{
    ...
    if ([teachers isKindOfClass:[NSArray class]]){
        for (id educationUser in teachers){
            [teachersResult addObject:[[MSGraphEducationUser alloc] initWithDictionary: educationUser]];
        }
    }
