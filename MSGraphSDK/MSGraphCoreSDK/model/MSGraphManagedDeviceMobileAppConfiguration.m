...
- (NSArray*) assignments
{
    ...
    if ([assignments isKindOfClass:[NSArray class]]){
        for (id managedDeviceMobileAppConfigurationAssignment in assignments){
            [assignmentsResult addObject:[[MSGraphManagedDeviceMobileAppConfigurationAssignment alloc] initWithDictionary: managedDeviceMobileAppConfigurationAssignment]];
        }
    }
...
- (NSArray*) userStatuses
{
    ...
    if ([userStatuses isKindOfClass:[NSArray class]]){
        for (id managedDeviceMobileAppConfigurationUserStatus in userStatuses){
            [userStatusesResult addObject:[[MSGraphManagedDeviceMobileAppConfigurationUserStatus alloc] initWithDictionary: managedDeviceMobileAppConfigurationUserStatus]];
        }
    }
