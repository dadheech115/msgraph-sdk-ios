...
- (NSArray*) compliantAppsList
{
    ...
    if ([compliantAppsList isKindOfClass:[NSArray class]]){
        for (id appListItem in compliantAppsList){
            [compliantAppsListResult addObject:[[MSGraphAppListItem alloc] initWithDictionary: appListItem]];
        }
    }
...
- (NSArray*) kioskModeApps
{
    ...
    if ([kioskModeApps isKindOfClass:[NSArray class]]){
        for (id appListItem in kioskModeApps){
            [kioskModeAppsResult addObject:[[MSGraphAppListItem alloc] initWithDictionary: appListItem]];
        }
    }
...
- (NSArray*) appsInstallAllowList
{
    ...
    if ([appsInstallAllowList isKindOfClass:[NSArray class]]){
        for (id appListItem in appsInstallAllowList){
            [appsInstallAllowListResult addObject:[[MSGraphAppListItem alloc] initWithDictionary: appListItem]];
        }
    }
...
- (NSArray*) appsLaunchBlockList
{
    ...
    if ([appsLaunchBlockList isKindOfClass:[NSArray class]]){
        for (id appListItem in appsLaunchBlockList){
            [appsLaunchBlockListResult addObject:[[MSGraphAppListItem alloc] initWithDictionary: appListItem]];
        }
    }
...
- (NSArray*) appsHideList
{
    ...
    if ([appsHideList isKindOfClass:[NSArray class]]){
        for (id appListItem in appsHideList){
            [appsHideListResult addObject:[[MSGraphAppListItem alloc] initWithDictionary: appListItem]];
        }
    }
