...
- (NSArray*) rolePermissions
{
    ...
    if ([rolePermissions isKindOfClass:[NSArray class]]){
        for (id rolePermission in rolePermissions){
            [rolePermissionsResult addObject:[[MSGraphRolePermission alloc] initWithDictionary: rolePermission]];
        }
    }
...
- (NSArray*) roleAssignments
{
    ...
    if ([roleAssignments isKindOfClass:[NSArray class]]){
        for (id roleAssignment in roleAssignments){
            [roleAssignmentsResult addObject:[[MSGraphRoleAssignment alloc] initWithDictionary: roleAssignment]];
        }
    }
