...
- (NSArray*) deviceComplianceSettingStates
{
    ...
    if ([deviceComplianceSettingStates isKindOfClass:[NSArray class]]){
        for (id deviceComplianceSettingState in deviceComplianceSettingStates){
            [deviceComplianceSettingStatesResult addObject:[[MSGraphDeviceComplianceSettingState alloc] initWithDictionary: deviceComplianceSettingState]];
        }
    }
