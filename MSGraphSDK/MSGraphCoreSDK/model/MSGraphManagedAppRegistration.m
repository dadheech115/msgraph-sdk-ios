...
- (NSArray*) flaggedReasons
{
    ...
    if ([flaggedReasons isKindOfClass:[NSArray class]]){
        for (id managedAppFlaggedReason in flaggedReasons){
            [flaggedReasonsResult addObject:[managedAppFlaggedReason toMSGraphManagedAppFlaggedReason]];
        }
    }
...
- (NSArray*) appliedPolicies
{
    ...
    if ([appliedPolicies isKindOfClass:[NSArray class]]){
        for (id managedAppPolicy in appliedPolicies){
            [appliedPoliciesResult addObject:[[MSGraphManagedAppPolicy alloc] initWithDictionary: managedAppPolicy]];
        }
    }
...
- (NSArray*) intendedPolicies
{
    ...
    if ([intendedPolicies isKindOfClass:[NSArray class]]){
        for (id managedAppPolicy in intendedPolicies){
            [intendedPoliciesResult addObject:[[MSGraphManagedAppPolicy alloc] initWithDictionary: managedAppPolicy]];
        }
    }
...
- (NSArray*) managedAppRegistrationOperations
{
    ...
    if ([managedAppRegistrationOperations isKindOfClass:[NSArray class]]){
        for (id managedAppOperation in managedAppRegistrationOperations){
            [managedAppRegistrationOperationsResult addObject:[[MSGraphManagedAppOperation alloc] initWithDictionary: managedAppOperation]];
        }
    }
