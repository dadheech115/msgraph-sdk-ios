...
- (NSArray*) scheduledActionConfigurations
{
    ...
    if ([scheduledActionConfigurations isKindOfClass:[NSArray class]]){
        for (id deviceComplianceActionItem in scheduledActionConfigurations){
            [scheduledActionConfigurationsResult addObject:[[MSGraphDeviceComplianceActionItem alloc] initWithDictionary: deviceComplianceActionItem]];
        }
    }
