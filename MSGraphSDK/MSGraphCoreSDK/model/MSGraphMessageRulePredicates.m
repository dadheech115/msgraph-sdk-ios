...
- (NSArray*) fromAddresses
{
    ...
    if ([fromAddresses isKindOfClass:[NSArray class]]){
        for (id recipient in fromAddresses){
            [fromAddressesResult addObject:[[MSGraphRecipient alloc] initWithDictionary: recipient]];
        }
    }
...
- (NSArray*) sentToAddresses
{
    ...
    if ([sentToAddresses isKindOfClass:[NSArray class]]){
        for (id recipient in sentToAddresses){
            [sentToAddressesResult addObject:[[MSGraphRecipient alloc] initWithDictionary: recipient]];
        }
    }
