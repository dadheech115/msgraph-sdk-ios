...
- (MSGraphMessageRequest *) requestWithOptions:(NSArray *)requestOptions
{
    return [[MSGraphMessageRequest alloc] initWithURL:self.requestURL requestOptions:requestOptions client:self.client];
}
