...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphWorkbookTableRowsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphWorkbookTableRowsCollectionRequest *nextRequest = [[MSGraphWorkbookTableRowsCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
