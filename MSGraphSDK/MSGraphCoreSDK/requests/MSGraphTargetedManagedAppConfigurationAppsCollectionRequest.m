...
@implementation MSGraphTargetedManagedAppConfigurationAppsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphTargetedManagedAppConfigurationAppsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphTargetedManagedAppConfigurationAppsCollectionRequest *nextRequest = [[MSGraphTargetedManagedAppConfigurationAppsCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
