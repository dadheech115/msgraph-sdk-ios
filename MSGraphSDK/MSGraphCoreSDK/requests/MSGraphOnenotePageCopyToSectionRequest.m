...
- (instancetype)initWithId:(NSString *)id groupId:(NSString *)groupId siteCollectionId:(NSString *)siteCollectionId siteId:(NSString *)siteId URL:(NSURL *)url requestOptions:(NSArray *)requestOptions client:(ODataBaseClient*)client
{
...
{
    NSDictionary *params = [[NSDictionary alloc] initWithObjectsAndKeys:[MSObject getNSJsonSerializationCompatibleValue:_id],@"id",[MSObject getNSJsonSerializationCompatibleValue:_groupId],@"groupId",[MSObject getNSJsonSerializationCompatibleValue:_siteCollectionId],@"siteCollectionId",[MSObject getNSJsonSerializationCompatibleValue:_siteId],@"siteId",nil];
