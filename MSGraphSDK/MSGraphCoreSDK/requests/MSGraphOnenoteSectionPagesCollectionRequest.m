...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphOnenoteSectionPagesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphOnenoteSectionPagesCollectionRequest *nextRequest = [[MSGraphOnenoteSectionPagesCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
