...
- (instancetype)initWithLookupValue:(NSDictionary *)lookupValue lookupVector:(NSDictionary *)lookupVector resultVector:(NSDictionary *)resultVector URL:(NSURL *)url requestOptions:(NSArray *)requestOptions client:(ODataBaseClient*)client
{
