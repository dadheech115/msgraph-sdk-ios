...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphDriveSpecialCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphDriveSpecialCollectionRequest *nextRequest = [[MSGraphDriveSpecialCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
