...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphSectionGroupSectionGroupsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphSectionGroupSectionGroupsCollectionRequest *nextRequest = [[MSGraphSectionGroupSectionGroupsCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
