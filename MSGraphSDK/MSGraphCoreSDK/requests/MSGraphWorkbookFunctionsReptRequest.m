...
- (instancetype)initWithText:(NSDictionary *)text numberTimes:(NSDictionary *)numberTimes URL:(NSURL *)url requestOptions:(NSArray *)requestOptions client:(ODataBaseClient*)client
{
