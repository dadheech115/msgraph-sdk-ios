...
@implementation MSGraphTargetedManagedAppProtectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(MSGraphTargetedManagedAppProtection *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphTargetedManagedAppProtection alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(MSGraphTargetedManagedAppProtection *)targetedManagedAppProtection
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[targetedManagedAppProtection dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:targetedManagedAppProtection]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphTargetedManagedAppProtection alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
