...
@implementation MSGraphGraphServiceWorkbooksCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphGraphServiceWorkbooksCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphGraphServiceWorkbooksCollectionRequest *nextRequest = [[MSGraphGraphServiceWorkbooksCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
