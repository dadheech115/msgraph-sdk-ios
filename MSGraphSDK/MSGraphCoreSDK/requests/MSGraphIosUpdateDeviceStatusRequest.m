...
@implementation MSGraphIosUpdateDeviceStatusRequest
...
- (NSMutableURLRequest *)update:(MSGraphIosUpdateDeviceStatus *)iosUpdateDeviceStatus
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[iosUpdateDeviceStatus dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:iosUpdateDeviceStatus]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphIosUpdateDeviceStatus alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
