...
@implementation MSGraphIosManagedAppProtectionAppsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphIosManagedAppProtectionAppsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphIosManagedAppProtectionAppsCollectionRequest *nextRequest = [[MSGraphIosManagedAppProtectionAppsCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
