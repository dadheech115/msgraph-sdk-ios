...
@implementation MSGraphDeviceCompliancePolicyDeviceStateSummaryRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(MSGraphDeviceCompliancePolicyDeviceStateSummary *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphDeviceCompliancePolicyDeviceStateSummary alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(MSGraphDeviceCompliancePolicyDeviceStateSummary *)deviceCompliancePolicyDeviceStateSummary
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[deviceCompliancePolicyDeviceStateSummary dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:deviceCompliancePolicyDeviceStateSummary]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphDeviceCompliancePolicyDeviceStateSummary alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
