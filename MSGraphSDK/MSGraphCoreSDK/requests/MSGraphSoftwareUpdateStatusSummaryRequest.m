...
@implementation MSGraphSoftwareUpdateStatusSummaryRequest
...
- (NSMutableURLRequest *)update:(MSGraphSoftwareUpdateStatusSummary *)softwareUpdateStatusSummary
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[softwareUpdateStatusSummary dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:softwareUpdateStatusSummary]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphSoftwareUpdateStatusSummary alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
