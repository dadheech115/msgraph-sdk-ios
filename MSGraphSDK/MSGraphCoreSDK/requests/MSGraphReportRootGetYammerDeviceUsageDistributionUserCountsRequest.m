...
@interface MSGraphReportRootGetYammerDeviceUsageDistributionUserCountsRequest()
...
@implementation MSGraphReportRootGetYammerDeviceUsageDistributionUserCountsRequest
