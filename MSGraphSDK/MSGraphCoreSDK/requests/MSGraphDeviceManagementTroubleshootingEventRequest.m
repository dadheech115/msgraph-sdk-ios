...
@implementation MSGraphDeviceManagementTroubleshootingEventRequest
...
- (NSMutableURLRequest *)update:(MSGraphDeviceManagementTroubleshootingEvent *)deviceManagementTroubleshootingEvent
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[deviceManagementTroubleshootingEvent dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:deviceManagementTroubleshootingEvent]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphDeviceManagementTroubleshootingEvent alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
