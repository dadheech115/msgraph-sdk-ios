...
@implementation MSGraphDeviceAndAppManagementRoleAssignmentRequest
...
- (NSMutableURLRequest *)update:(MSGraphDeviceAndAppManagementRoleAssignment *)deviceAndAppManagementRoleAssignment
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[deviceAndAppManagementRoleAssignment dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:deviceAndAppManagementRoleAssignment]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphDeviceAndAppManagementRoleAssignment alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
