...
@implementation MSGraphAndroidLobAppRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(MSGraphAndroidLobApp *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphAndroidLobApp alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(MSGraphAndroidLobApp *)androidLobApp
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[androidLobApp dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:androidLobApp]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphAndroidLobApp alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
