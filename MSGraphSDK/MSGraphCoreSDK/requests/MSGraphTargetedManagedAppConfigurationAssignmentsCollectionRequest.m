...
@implementation MSGraphTargetedManagedAppConfigurationAssignmentsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphTargetedManagedAppConfigurationAssignmentsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphTargetedManagedAppConfigurationAssignmentsCollectionRequest *nextRequest = [[MSGraphTargetedManagedAppConfigurationAssignmentsCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
