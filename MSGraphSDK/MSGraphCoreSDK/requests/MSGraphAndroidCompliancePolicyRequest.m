...
@implementation MSGraphAndroidCompliancePolicyRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(MSGraphAndroidCompliancePolicy *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphAndroidCompliancePolicy alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(MSGraphAndroidCompliancePolicy *)androidCompliancePolicy
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[androidCompliancePolicy dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:androidCompliancePolicy]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphAndroidCompliancePolicy alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
