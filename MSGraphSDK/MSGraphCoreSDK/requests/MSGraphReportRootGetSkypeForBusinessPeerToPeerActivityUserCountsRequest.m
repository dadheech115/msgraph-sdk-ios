...
@interface MSGraphReportRootGetSkypeForBusinessPeerToPeerActivityUserCountsRequest()
...
@implementation MSGraphReportRootGetSkypeForBusinessPeerToPeerActivityUserCountsRequest
