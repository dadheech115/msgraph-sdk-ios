...
@implementation MSGraphTargetedManagedAppConfigurationRequest
...
- (NSMutableURLRequest *)update:(MSGraphTargetedManagedAppConfiguration *)targetedManagedAppConfiguration
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[targetedManagedAppConfiguration dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:targetedManagedAppConfiguration]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphTargetedManagedAppConfiguration alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
