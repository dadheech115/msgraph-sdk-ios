...
@interface MSGraphReportRootGetSkypeForBusinessParticipantActivityCountsRequest()
...
@implementation MSGraphReportRootGetSkypeForBusinessParticipantActivityCountsRequest
