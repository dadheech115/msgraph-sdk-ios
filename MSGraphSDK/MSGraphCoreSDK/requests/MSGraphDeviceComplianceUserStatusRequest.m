...
@implementation MSGraphDeviceComplianceUserStatusRequest
...
- (NSMutableURLRequest *)update:(MSGraphDeviceComplianceUserStatus *)deviceComplianceUserStatus
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[deviceComplianceUserStatus dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:deviceComplianceUserStatus]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphDeviceComplianceUserStatus alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
