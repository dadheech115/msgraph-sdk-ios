...
@implementation MSGraphRemoteAssistancePartnerRequest
...
- (NSMutableURLRequest *)update:(MSGraphRemoteAssistancePartner *)remoteAssistancePartner
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[remoteAssistancePartner dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:remoteAssistancePartner]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphRemoteAssistancePartner alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
