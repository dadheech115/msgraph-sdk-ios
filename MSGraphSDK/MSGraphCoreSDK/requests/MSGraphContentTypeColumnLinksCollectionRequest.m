...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphContentTypeColumnLinksCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphContentTypeColumnLinksCollectionRequest *nextRequest = [[MSGraphContentTypeColumnLinksCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
