...
@implementation MSGraphDefaultManagedAppProtectionRequest
...
- (NSMutableURLRequest *)update:(MSGraphDefaultManagedAppProtection *)defaultManagedAppProtection
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[defaultManagedAppProtection dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:defaultManagedAppProtection]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphDefaultManagedAppProtection alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
