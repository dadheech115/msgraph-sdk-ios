...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphWorkbookTableColumnsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphWorkbookTableColumnsCollectionRequest *nextRequest = [[MSGraphWorkbookTableColumnsCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
