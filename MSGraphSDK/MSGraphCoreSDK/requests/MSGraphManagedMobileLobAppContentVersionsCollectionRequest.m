...
@implementation MSGraphManagedMobileLobAppContentVersionsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphManagedMobileLobAppContentVersionsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphManagedMobileLobAppContentVersionsCollectionRequest *nextRequest = [[MSGraphManagedMobileLobAppContentVersionsCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
