...
@interface MSGraphReportRootGetSkypeForBusinessPeerToPeerActivityCountsRequest()
...
@implementation MSGraphReportRootGetSkypeForBusinessPeerToPeerActivityCountsRequest
