...
@implementation MSGraphManagedAppStatusRequest
...
- (NSMutableURLRequest *)update:(MSGraphManagedAppStatus *)managedAppStatus
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[managedAppStatus dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:managedAppStatus]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphManagedAppStatus alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
