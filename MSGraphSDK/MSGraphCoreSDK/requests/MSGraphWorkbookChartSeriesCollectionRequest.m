...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphWorkbookChartSeriesCollectionCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphWorkbookChartSeriesCollectionRequest *nextRequest = [[MSGraphWorkbookChartSeriesCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
