...
- (MSGraphWorkbookTableSortRequest *) requestWithOptions:(NSArray *)requestOptions
{
    return [[MSGraphWorkbookTableSortRequest alloc] initWithURL:self.requestURL requestOptions:requestOptions client:self.client];
}
