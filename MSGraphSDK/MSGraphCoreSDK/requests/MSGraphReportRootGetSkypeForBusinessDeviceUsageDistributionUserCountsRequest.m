...
@interface MSGraphReportRootGetSkypeForBusinessDeviceUsageDistributionUserCountsRequest()
...
@implementation MSGraphReportRootGetSkypeForBusinessDeviceUsageDistributionUserCountsRequest
