...
@implementation MSGraphWindowsInformationProtectionNetworkLearningSummaryRequest
...
- (NSMutableURLRequest *)update:(MSGraphWindowsInformationProtectionNetworkLearningSummary *)windowsInformationProtectionNetworkLearningSummary
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[windowsInformationProtectionNetworkLearningSummary dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:windowsInformationProtectionNetworkLearningSummary]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphWindowsInformationProtectionNetworkLearningSummary alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
