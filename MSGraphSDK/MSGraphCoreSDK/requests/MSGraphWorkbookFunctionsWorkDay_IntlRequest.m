...
- (instancetype)initWithStartDate:(NSDictionary *)startDate days:(NSDictionary *)days weekend:(NSDictionary *)weekend holidays:(NSDictionary *)holidays URL:(NSURL *)url requestOptions:(NSArray *)requestOptions client:(ODataBaseClient*)client
{
