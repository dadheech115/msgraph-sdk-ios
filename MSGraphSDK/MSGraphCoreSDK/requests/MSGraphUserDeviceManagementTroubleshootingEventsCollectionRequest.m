...
@implementation MSGraphUserDeviceManagementTroubleshootingEventsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphUserDeviceManagementTroubleshootingEventsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphUserDeviceManagementTroubleshootingEventsCollectionRequest *nextRequest = [[MSGraphUserDeviceManagementTroubleshootingEventsCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
