...
@implementation MSGraphManagedDeviceMobileAppConfigurationAssignmentRequest
...
- (NSMutableURLRequest *)update:(MSGraphManagedDeviceMobileAppConfigurationAssignment *)managedDeviceMobileAppConfigurationAssignment
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[managedDeviceMobileAppConfigurationAssignment dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:managedDeviceMobileAppConfigurationAssignment]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphManagedDeviceMobileAppConfigurationAssignment alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
