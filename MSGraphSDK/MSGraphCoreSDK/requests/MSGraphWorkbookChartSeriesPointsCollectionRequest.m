...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphWorkbookChartSeriesPointsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphWorkbookChartSeriesPointsCollectionRequest *nextRequest = [[MSGraphWorkbookChartSeriesPointsCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
