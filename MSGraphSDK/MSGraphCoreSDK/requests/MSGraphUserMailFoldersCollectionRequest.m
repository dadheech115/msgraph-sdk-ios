...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphUserMailFoldersCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphUserMailFoldersCollectionRequest *nextRequest = [[MSGraphUserMailFoldersCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
