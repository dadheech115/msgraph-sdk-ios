...
@implementation MSGraphGroupLifecyclePolicyRequest
...
- (NSMutableURLRequest *)update:(MSGraphGroupLifecyclePolicy *)groupLifecyclePolicy
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[groupLifecyclePolicy dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:groupLifecyclePolicy]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphGroupLifecyclePolicy alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
