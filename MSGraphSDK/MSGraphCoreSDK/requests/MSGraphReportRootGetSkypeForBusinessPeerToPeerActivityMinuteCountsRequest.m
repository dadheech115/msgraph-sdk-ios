...
@interface MSGraphReportRootGetSkypeForBusinessPeerToPeerActivityMinuteCountsRequest()
...
@implementation MSGraphReportRootGetSkypeForBusinessPeerToPeerActivityMinuteCountsRequest
