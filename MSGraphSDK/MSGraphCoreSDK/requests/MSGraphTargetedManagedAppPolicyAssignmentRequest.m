...
@implementation MSGraphTargetedManagedAppPolicyAssignmentRequest
...
- (NSMutableURLRequest *)update:(MSGraphTargetedManagedAppPolicyAssignment *)targetedManagedAppPolicyAssignment
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[targetedManagedAppPolicyAssignment dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:targetedManagedAppPolicyAssignment]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphTargetedManagedAppPolicyAssignment alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
