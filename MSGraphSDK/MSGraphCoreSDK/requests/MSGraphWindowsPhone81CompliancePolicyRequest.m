...
@implementation MSGraphWindowsPhone81CompliancePolicyRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(MSGraphWindowsPhone81CompliancePolicy *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphWindowsPhone81CompliancePolicy alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(MSGraphWindowsPhone81CompliancePolicy *)windowsPhone81CompliancePolicy
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[windowsPhone81CompliancePolicy dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:windowsPhone81CompliancePolicy]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphWindowsPhone81CompliancePolicy alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
