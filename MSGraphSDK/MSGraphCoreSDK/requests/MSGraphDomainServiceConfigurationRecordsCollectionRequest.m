...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphDomainServiceConfigurationRecordsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphDomainServiceConfigurationRecordsCollectionRequest *nextRequest = [[MSGraphDomainServiceConfigurationRecordsCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
