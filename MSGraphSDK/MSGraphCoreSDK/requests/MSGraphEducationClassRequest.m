...
@implementation MSGraphEducationClassRequest
...
- (NSMutableURLRequest *)update:(MSGraphEducationClass *)educationClass
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[educationClass dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:educationClass]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphEducationClass alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
