...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphContactMultiValueExtendedPropertiesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphContactMultiValueExtendedPropertiesCollectionRequest *nextRequest = [[MSGraphContactMultiValueExtendedPropertiesCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
