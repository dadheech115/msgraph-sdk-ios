...
@interface MSGraphReportRootGetYammerDeviceUsageUserDetailRequestBuilder()
...
@implementation MSGraphReportRootGetYammerDeviceUsageUserDetailRequestBuilder
...
- (MSGraphReportRootGetYammerDeviceUsageUserDetailRequest *)requestWithOptions:(NSArray *)requestOptions
{
    ...
    return [[MSGraphReportRootGetYammerDeviceUsageUserDetailRequest alloc] initWithDate:self.date
                                                                                    URL:self.requestURL
