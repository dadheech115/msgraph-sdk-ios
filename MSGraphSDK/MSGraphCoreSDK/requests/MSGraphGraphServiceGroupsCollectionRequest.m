...
@implementation MSGraphGraphServiceGroupsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphGraphServiceGroupsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphGraphServiceGroupsCollectionRequest *nextRequest = [[MSGraphGraphServiceGroupsCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
