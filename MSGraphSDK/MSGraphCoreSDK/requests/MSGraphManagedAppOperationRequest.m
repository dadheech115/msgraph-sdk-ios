...
@implementation MSGraphManagedAppOperationRequest
...
- (NSMutableURLRequest *)update:(MSGraphManagedAppOperation *)managedAppOperation
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[managedAppOperation dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:managedAppOperation]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphManagedAppOperation alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
