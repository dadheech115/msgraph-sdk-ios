...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphPostAttachmentsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphPostAttachmentsCollectionRequest *nextRequest = [[MSGraphPostAttachmentsCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
