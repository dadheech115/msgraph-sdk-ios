...
- (instancetype)initWithValues:(NSDictionary *)values dates:(NSDictionary *)dates guess:(NSDictionary *)guess URL:(NSURL *)url requestOptions:(NSArray *)requestOptions client:(ODataBaseClient*)client
{
