...
@implementation MSGraphManagedAppRegistrationAppliedPoliciesCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphManagedAppRegistrationAppliedPoliciesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphManagedAppRegistrationAppliedPoliciesCollectionRequest *nextRequest = [[MSGraphManagedAppRegistrationAppliedPoliciesCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
