...
@implementation MSGraphDeviceCompliancePolicyDeviceSettingStateSummariesCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphDeviceCompliancePolicyDeviceSettingStateSummariesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphDeviceCompliancePolicyDeviceSettingStateSummariesCollectionRequest *nextRequest = [[MSGraphDeviceCompliancePolicyDeviceSettingStateSummariesCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
