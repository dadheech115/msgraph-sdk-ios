...
@implementation MSGraphIosCustomConfigurationRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(MSGraphIosCustomConfiguration *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphIosCustomConfiguration alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(MSGraphIosCustomConfiguration *)iosCustomConfiguration
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[iosCustomConfiguration dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:iosCustomConfiguration]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphIosCustomConfiguration alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
