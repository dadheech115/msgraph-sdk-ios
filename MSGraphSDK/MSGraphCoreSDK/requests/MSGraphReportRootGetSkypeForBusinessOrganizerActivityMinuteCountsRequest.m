...
@interface MSGraphReportRootGetSkypeForBusinessOrganizerActivityMinuteCountsRequest()
...
@implementation MSGraphReportRootGetSkypeForBusinessOrganizerActivityMinuteCountsRequest
