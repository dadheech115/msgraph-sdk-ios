...
- (instancetype)initWithDeltaRows:(int32_t)deltaRows deltaColumns:(int32_t)deltaColumns URL:(NSURL *)url requestOptions:(NSArray *)requestOptions client:(ODataBaseClient*)client
{
...
{
    [self.requestOptions addObject:[[MSFunctionParameters alloc] initWithKey:@"deltaRows"
                                                                value:[MSObject getNSJsonSerializationCompatibleValue:@(_deltaRows)]]];
    [self.requestOptions addObject:[[MSFunctionParameters alloc] initWithKey:@"deltaColumns"
