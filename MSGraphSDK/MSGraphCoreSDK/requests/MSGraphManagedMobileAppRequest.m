...
@implementation MSGraphManagedMobileAppRequest
...
- (NSMutableURLRequest *)update:(MSGraphManagedMobileApp *)managedMobileApp
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[managedMobileApp dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:managedMobileApp]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphManagedMobileApp alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
