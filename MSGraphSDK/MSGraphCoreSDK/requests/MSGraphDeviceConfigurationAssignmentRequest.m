...
@implementation MSGraphDeviceConfigurationAssignmentRequest
...
- (NSMutableURLRequest *)update:(MSGraphDeviceConfigurationAssignment *)deviceConfigurationAssignment
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[deviceConfigurationAssignment dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:deviceConfigurationAssignment]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphDeviceConfigurationAssignment alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
