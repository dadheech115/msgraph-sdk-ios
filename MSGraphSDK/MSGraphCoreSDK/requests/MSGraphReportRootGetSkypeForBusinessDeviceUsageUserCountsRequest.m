...
@interface MSGraphReportRootGetSkypeForBusinessDeviceUsageUserCountsRequest()
...
@implementation MSGraphReportRootGetSkypeForBusinessDeviceUsageUserCountsRequest
