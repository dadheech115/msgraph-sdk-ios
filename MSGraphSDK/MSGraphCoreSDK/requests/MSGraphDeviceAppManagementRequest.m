...
@implementation MSGraphDeviceAppManagementRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(MSGraphDeviceAppManagement *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphDeviceAppManagement alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(MSGraphDeviceAppManagement *)deviceAppManagement
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[deviceAppManagement dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:deviceAppManagement]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphDeviceAppManagement alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
