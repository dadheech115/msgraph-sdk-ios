...
@implementation MSGraphWindowsInformationProtectionAssignmentsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphWindowsInformationProtectionAssignmentsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphWindowsInformationProtectionAssignmentsCollectionRequest *nextRequest = [[MSGraphWindowsInformationProtectionAssignmentsCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
