...
@implementation MSGraphManagedEBookAssignmentRequest
...
- (NSMutableURLRequest *)update:(MSGraphManagedEBookAssignment *)managedEBookAssignment
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[managedEBookAssignment dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:managedEBookAssignment]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphManagedEBookAssignment alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
