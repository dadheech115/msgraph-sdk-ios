...
@implementation MSGraphDeviceEnrollmentConfigurationRequest
...
- (NSMutableURLRequest *)update:(MSGraphDeviceEnrollmentConfiguration *)deviceEnrollmentConfiguration
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[deviceEnrollmentConfiguration dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:deviceEnrollmentConfiguration]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphDeviceEnrollmentConfiguration alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
