...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphCalendarGroupCalendarsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphCalendarGroupCalendarsCollectionRequest *nextRequest = [[MSGraphCalendarGroupCalendarsCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
