...
@implementation MSGraphIosManagedAppProtectionRequest
...
- (NSMutableURLRequest *)update:(MSGraphIosManagedAppProtection *)iosManagedAppProtection
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[iosManagedAppProtection dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:iosManagedAppProtection]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphIosManagedAppProtection alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
