...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphConversationThreadPostsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphConversationThreadPostsCollectionRequest *nextRequest = [[MSGraphConversationThreadPostsCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
