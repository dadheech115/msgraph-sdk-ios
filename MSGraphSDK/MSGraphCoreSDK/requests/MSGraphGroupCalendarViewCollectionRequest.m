...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphGroupCalendarViewCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphGroupCalendarViewCollectionRequest *nextRequest = [[MSGraphGroupCalendarViewCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
