...
@implementation MSGraphDeviceCompliancePolicySettingStateSummaryRequest
...
- (NSMutableURLRequest *)update:(MSGraphDeviceCompliancePolicySettingStateSummary *)deviceCompliancePolicySettingStateSummary
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[deviceCompliancePolicySettingStateSummary dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:deviceCompliancePolicySettingStateSummary]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphDeviceCompliancePolicySettingStateSummary alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
