...
@implementation MSGraphResourceOperationRequest
...
- (NSMutableURLRequest *)update:(MSGraphResourceOperation *)resourceOperation
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[resourceOperation dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:resourceOperation]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphResourceOperation alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
