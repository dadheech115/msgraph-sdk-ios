...
@implementation MSGraphDirectoryDeletedItemsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphDirectoryDeletedItemsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphDirectoryDeletedItemsCollectionRequest *nextRequest = [[MSGraphDirectoryDeletedItemsCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
