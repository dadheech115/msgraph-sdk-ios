...
@implementation MSGraphMobileAppCategoriesCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphMobileAppCategoriesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphMobileAppCategoriesCollectionRequest *nextRequest = [[MSGraphMobileAppCategoriesCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
