...
@implementation MSGraphDeviceManagementExchangeConnectorRequest
...
- (NSMutableURLRequest *)update:(MSGraphDeviceManagementExchangeConnector *)deviceManagementExchangeConnector
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[deviceManagementExchangeConnector dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:deviceManagementExchangeConnector]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphDeviceManagementExchangeConnector alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
