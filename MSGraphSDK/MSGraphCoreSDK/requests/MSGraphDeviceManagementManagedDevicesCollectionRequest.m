...
@implementation MSGraphDeviceManagementManagedDevicesCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphDeviceManagementManagedDevicesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphDeviceManagementManagedDevicesCollectionRequest *nextRequest = [[MSGraphDeviceManagementManagedDevicesCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
