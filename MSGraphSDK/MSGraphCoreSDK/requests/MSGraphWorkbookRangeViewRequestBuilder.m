...
- (MSGraphWorkbookRangeViewRequest *) requestWithOptions:(NSArray *)requestOptions
{
    return [[MSGraphWorkbookRangeViewRequest alloc] initWithURL:self.requestURL requestOptions:requestOptions client:self.client];
}
