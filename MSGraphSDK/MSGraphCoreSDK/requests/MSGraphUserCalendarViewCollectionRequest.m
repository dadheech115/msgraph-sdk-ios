...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphUserCalendarViewCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphUserCalendarViewCollectionRequest *nextRequest = [[MSGraphUserCalendarViewCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
