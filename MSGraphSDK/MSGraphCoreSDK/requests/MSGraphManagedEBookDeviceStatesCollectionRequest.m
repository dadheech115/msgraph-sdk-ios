...
@implementation MSGraphManagedEBookDeviceStatesCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphManagedEBookDeviceStatesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphManagedEBookDeviceStatesCollectionRequest *nextRequest = [[MSGraphManagedEBookDeviceStatesCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
