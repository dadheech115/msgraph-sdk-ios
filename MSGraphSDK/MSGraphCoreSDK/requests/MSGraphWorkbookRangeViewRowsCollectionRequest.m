...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphWorkbookRangeViewRowsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphWorkbookRangeViewRowsCollectionRequest *nextRequest = [[MSGraphWorkbookRangeViewRowsCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
