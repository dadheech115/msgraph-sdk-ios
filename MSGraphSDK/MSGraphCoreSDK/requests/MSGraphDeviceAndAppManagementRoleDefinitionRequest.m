...
@implementation MSGraphDeviceAndAppManagementRoleDefinitionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(MSGraphDeviceAndAppManagementRoleDefinition *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphDeviceAndAppManagementRoleDefinition alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(MSGraphDeviceAndAppManagementRoleDefinition *)deviceAndAppManagementRoleDefinition
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[deviceAndAppManagementRoleDefinition dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:deviceAndAppManagementRoleDefinition]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphDeviceAndAppManagementRoleDefinition alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
