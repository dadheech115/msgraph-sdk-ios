...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphWorkbookWorksheetNamesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphWorkbookWorksheetNamesCollectionRequest *nextRequest = [[MSGraphWorkbookWorksheetNamesCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
