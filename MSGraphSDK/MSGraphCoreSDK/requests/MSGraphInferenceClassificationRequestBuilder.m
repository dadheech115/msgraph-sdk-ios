...
- (MSGraphInferenceClassificationRequest *) requestWithOptions:(NSArray *)requestOptions
{
    return [[MSGraphInferenceClassificationRequest alloc] initWithURL:self.requestURL requestOptions:requestOptions client:self.client];
}
