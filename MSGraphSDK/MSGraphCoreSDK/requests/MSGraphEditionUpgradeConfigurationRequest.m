...
@implementation MSGraphEditionUpgradeConfigurationRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(MSGraphEditionUpgradeConfiguration *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphEditionUpgradeConfiguration alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(MSGraphEditionUpgradeConfiguration *)editionUpgradeConfiguration
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[editionUpgradeConfiguration dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:editionUpgradeConfiguration]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphEditionUpgradeConfiguration alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
