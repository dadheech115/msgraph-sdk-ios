...
@interface MSGraphReportRootGetSkypeForBusinessParticipantActivityMinuteCountsRequest()
...
@implementation MSGraphReportRootGetSkypeForBusinessParticipantActivityMinuteCountsRequest
