...
@implementation MSGraphDeviceComplianceUserOverviewRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(MSGraphDeviceComplianceUserOverview *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphDeviceComplianceUserOverview alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(MSGraphDeviceComplianceUserOverview *)deviceComplianceUserOverview
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[deviceComplianceUserOverview dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:deviceComplianceUserOverview]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphDeviceComplianceUserOverview alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
