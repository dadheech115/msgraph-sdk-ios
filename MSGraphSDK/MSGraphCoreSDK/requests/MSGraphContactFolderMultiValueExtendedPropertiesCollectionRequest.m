...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphContactFolderMultiValueExtendedPropertiesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphContactFolderMultiValueExtendedPropertiesCollectionRequest *nextRequest = [[MSGraphContactFolderMultiValueExtendedPropertiesCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
