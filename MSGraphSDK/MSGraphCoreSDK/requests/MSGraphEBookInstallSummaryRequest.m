...
@implementation MSGraphEBookInstallSummaryRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(MSGraphEBookInstallSummary *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphEBookInstallSummary alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(MSGraphEBookInstallSummary *)eBookInstallSummary
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[eBookInstallSummary dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:eBookInstallSummary]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphEBookInstallSummary alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
