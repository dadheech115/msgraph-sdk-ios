...
@interface MSGraphReportRootGetMailboxUsageQuotaStatusMailboxCountsRequest()
...
@implementation MSGraphReportRootGetMailboxUsageQuotaStatusMailboxCountsRequest
