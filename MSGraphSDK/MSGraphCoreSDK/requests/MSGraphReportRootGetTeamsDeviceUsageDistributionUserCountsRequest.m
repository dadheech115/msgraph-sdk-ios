...
@interface MSGraphReportRootGetTeamsDeviceUsageDistributionUserCountsRequest()
...
@implementation MSGraphReportRootGetTeamsDeviceUsageDistributionUserCountsRequest
