...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphSharedDriveItemItemsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphSharedDriveItemItemsCollectionRequest *nextRequest = [[MSGraphSharedDriveItemItemsCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
