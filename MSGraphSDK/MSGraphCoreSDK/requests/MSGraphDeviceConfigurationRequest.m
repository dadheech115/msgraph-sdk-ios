...
@implementation MSGraphDeviceConfigurationRequest
...
- (NSMutableURLRequest *)update:(MSGraphDeviceConfiguration *)deviceConfiguration
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[deviceConfiguration dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:deviceConfiguration]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphDeviceConfiguration alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
