...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphDriveItemChildrenCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphDriveItemChildrenCollectionRequest *nextRequest = [[MSGraphDriveItemChildrenCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
