...
@implementation MSGraphUserInstallStateSummaryRequest
...
- (NSMutableURLRequest *)update:(MSGraphUserInstallStateSummary *)userInstallStateSummary
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[userInstallStateSummary dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:userInstallStateSummary]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphUserInstallStateSummary alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
