...
@implementation MSGraphEducationRootClassesCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphEducationRootClassesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphEducationRootClassesCollectionRequest *nextRequest = [[MSGraphEducationRootClassesCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
...
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[educationClass dictionaryFromItem]
                                                   options:0
                                                     error:nil];
