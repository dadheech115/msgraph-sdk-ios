...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphEventInstancesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphEventInstancesCollectionRequest *nextRequest = [[MSGraphEventInstancesCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
