...
@implementation MSGraphMobileAppContentRequest
...
- (NSMutableURLRequest *)update:(MSGraphMobileAppContent *)mobileAppContent
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[mobileAppContent dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:mobileAppContent]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphMobileAppContent alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
