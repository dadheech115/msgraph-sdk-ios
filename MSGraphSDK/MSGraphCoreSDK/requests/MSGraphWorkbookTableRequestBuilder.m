...
- (MSGraphWorkbookTableRequest *) requestWithOptions:(NSArray *)requestOptions
{
    return [[MSGraphWorkbookTableRequest alloc] initWithURL:self.requestURL requestOptions:requestOptions client:self.client];
}
