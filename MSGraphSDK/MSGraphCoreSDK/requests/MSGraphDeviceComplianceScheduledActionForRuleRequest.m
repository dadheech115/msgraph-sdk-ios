...
@implementation MSGraphDeviceComplianceScheduledActionForRuleRequest
...
- (NSMutableURLRequest *)update:(MSGraphDeviceComplianceScheduledActionForRule *)deviceComplianceScheduledActionForRule
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[deviceComplianceScheduledActionForRule dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:deviceComplianceScheduledActionForRule]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphDeviceComplianceScheduledActionForRule alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
