...
@implementation MSGraphEducationOrganizationRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(MSGraphEducationOrganization *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphEducationOrganization alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(MSGraphEducationOrganization *)educationOrganization
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[educationOrganization dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:educationOrganization]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphEducationOrganization alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
