...
@implementation MSGraphWindowsInformationProtectionAppLearningSummaryRequest
...
- (NSMutableURLRequest *)update:(MSGraphWindowsInformationProtectionAppLearningSummary *)windowsInformationProtectionAppLearningSummary
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[windowsInformationProtectionAppLearningSummary dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:windowsInformationProtectionAppLearningSummary]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphWindowsInformationProtectionAppLearningSummary alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
