...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphListColumnsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphListColumnsCollectionRequest *nextRequest = [[MSGraphListColumnsCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
