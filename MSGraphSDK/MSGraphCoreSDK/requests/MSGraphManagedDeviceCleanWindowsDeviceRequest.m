...
@interface MSGraphManagedDeviceCleanWindowsDeviceRequest()
...
@implementation MSGraphManagedDeviceCleanWindowsDeviceRequest
...
{
    NSParameterAssert(keepUserData);
...
{
    NSDictionary *params = [[NSDictionary alloc] initWithObjectsAndKeys:[MSObject getNSJsonSerializationCompatibleValue:@(_keepUserData)],@"keepUserData",nil];
