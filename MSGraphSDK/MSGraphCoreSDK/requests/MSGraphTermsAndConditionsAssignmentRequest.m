...
@implementation MSGraphTermsAndConditionsAssignmentRequest
...
- (NSMutableURLRequest *)update:(MSGraphTermsAndConditionsAssignment *)termsAndConditionsAssignment
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[termsAndConditionsAssignment dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:termsAndConditionsAssignment]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphTermsAndConditionsAssignment alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
