...
@interface MSGraphDeviceConfigurationAssignRequest()
...
@implementation MSGraphDeviceConfigurationAssignRequest
...
- (MSURLSessionDataTask *)executeWithCompletion:(void (^)(MSCollection *response, MSGraphDeviceConfigurationAssignRequest *nextRequest, NSError *error))completionHandler
{
    ...
    MSURLSessionDataTask *task = [self collectionTaskWithRequest:self.mutableRequest
                                          odObjectWithDictionary:^(id responseObject){
                                                                     return [[MSGraphDeviceConfigurationAssignment alloc] initWithDictionary:responseObject];
                                                                 }
                                                      completion:^(MSCollection *collectionResponse, NSError *error){
                                      if(!error && collectionResponse.nextLink && completionHandler){
                                              MSGraphDeviceConfigurationAssignRequest *nextRequest = [[MSGraphDeviceConfigurationAssignRequest alloc] initWithURL:collectionResponse.nextLink
                                                                                                                  requestOptions:nil
                                                                                                                  client:self.client];
