...
@implementation MSGraphLocalizedNotificationMessageRequest
...
- (NSMutableURLRequest *)update:(MSGraphLocalizedNotificationMessage *)localizedNotificationMessage
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[localizedNotificationMessage dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:localizedNotificationMessage]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphLocalizedNotificationMessage alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
