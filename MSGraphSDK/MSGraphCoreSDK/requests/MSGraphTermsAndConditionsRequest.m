...
@implementation MSGraphTermsAndConditionsRequest
...
- (NSMutableURLRequest *)update:(MSGraphTermsAndConditions *)termsAndConditions
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[termsAndConditions dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:termsAndConditions]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphTermsAndConditions alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
