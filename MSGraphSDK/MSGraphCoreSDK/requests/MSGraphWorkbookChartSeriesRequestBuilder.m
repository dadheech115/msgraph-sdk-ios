...
- (MSGraphWorkbookChartSeriesRequest *) requestWithOptions:(NSArray *)requestOptions
{
    return [[MSGraphWorkbookChartSeriesRequest alloc] initWithURL:self.requestURL requestOptions:requestOptions client:self.client];
}
