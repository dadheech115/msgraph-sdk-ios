...
@implementation MSGraphNotificationMessageTemplateRequest
...
- (NSMutableURLRequest *)update:(MSGraphNotificationMessageTemplate *)notificationMessageTemplate
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[notificationMessageTemplate dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:notificationMessageTemplate]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphNotificationMessageTemplate alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
