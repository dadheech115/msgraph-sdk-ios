...
@interface MSGraphReportRootGetSkypeForBusinessParticipantActivityUserCountsRequest()
...
@implementation MSGraphReportRootGetSkypeForBusinessParticipantActivityUserCountsRequest
