...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphOrganizationExtensionsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphOrganizationExtensionsCollectionRequest *nextRequest = [[MSGraphOrganizationExtensionsCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
