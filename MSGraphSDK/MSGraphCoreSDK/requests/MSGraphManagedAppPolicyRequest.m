...
@implementation MSGraphManagedAppPolicyRequest
...
- (NSMutableURLRequest *)update:(MSGraphManagedAppPolicy *)managedAppPolicy
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[managedAppPolicy dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:managedAppPolicy]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphManagedAppPolicy alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
