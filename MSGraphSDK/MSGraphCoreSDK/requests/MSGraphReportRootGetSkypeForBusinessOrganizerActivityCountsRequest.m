...
@interface MSGraphReportRootGetSkypeForBusinessOrganizerActivityCountsRequest()
...
@implementation MSGraphReportRootGetSkypeForBusinessOrganizerActivityCountsRequest
