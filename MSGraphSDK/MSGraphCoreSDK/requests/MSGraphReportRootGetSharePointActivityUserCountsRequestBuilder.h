...
@class MSGraphReportRootGetSharePointActivityUserCountsRequest;

@interface MSGraphReportRootGetSharePointActivityUserCountsRequestBuilder : MSRequestBuilder
