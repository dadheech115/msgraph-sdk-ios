...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphEventSingleValueExtendedPropertiesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphEventSingleValueExtendedPropertiesCollectionRequest *nextRequest = [[MSGraphEventSingleValueExtendedPropertiesCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
