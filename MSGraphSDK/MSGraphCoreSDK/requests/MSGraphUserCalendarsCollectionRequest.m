...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphUserCalendarsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphUserCalendarsCollectionRequest *nextRequest = [[MSGraphUserCalendarsCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
