...
- (instancetype)initWithRowOffset:(int32_t)rowOffset columnOffset:(int32_t)columnOffset URL:(NSURL *)url requestOptions:(NSArray *)requestOptions client:(ODataBaseClient*)client
{
...
{
    [self.requestOptions addObject:[[MSFunctionParameters alloc] initWithKey:@"rowOffset"
                                                                value:[MSObject getNSJsonSerializationCompatibleValue:@(_rowOffset)]]];
    [self.requestOptions addObject:[[MSFunctionParameters alloc] initWithKey:@"columnOffset"
