...
@implementation MSGraphGraphServiceGroupLifecyclePoliciesCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphGraphServiceGroupLifecyclePoliciesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphGraphServiceGroupLifecyclePoliciesCollectionRequest *nextRequest = [[MSGraphGraphServiceGroupLifecyclePoliciesCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
