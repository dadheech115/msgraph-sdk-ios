...
- (MSGraphConversationThreadsCollectionRequest *)requestWithOptions:(NSArray *)requestOptions
{
    return [[MSGraphConversationThreadsCollectionRequest alloc] initWithURL:self.requestURL requestOptions:requestOptions client:self.client];
}
