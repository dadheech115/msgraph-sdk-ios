...
@implementation MSGraphDeviceCompliancePolicyAssignmentRequest
...
- (NSMutableURLRequest *)update:(MSGraphDeviceCompliancePolicyAssignment *)deviceCompliancePolicyAssignment
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[deviceCompliancePolicyAssignment dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:deviceCompliancePolicyAssignment]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphDeviceCompliancePolicyAssignment alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
