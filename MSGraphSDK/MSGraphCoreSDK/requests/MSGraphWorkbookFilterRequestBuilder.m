...
- (MSGraphWorkbookFilterApplyValuesFilterRequestBuilder *)applyValuesFilterWithValues:(NSDictionary *)values 
{
...
- (MSGraphWorkbookFilterRequest *) requestWithOptions:(NSArray *)requestOptions
{
    return [[MSGraphWorkbookFilterRequest alloc] initWithURL:self.requestURL requestOptions:requestOptions client:self.client];
}
