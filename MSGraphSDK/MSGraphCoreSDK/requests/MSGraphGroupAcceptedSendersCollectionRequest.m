...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphGroupAcceptedSendersCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphGroupAcceptedSendersCollectionRequest *nextRequest = [[MSGraphGroupAcceptedSendersCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
