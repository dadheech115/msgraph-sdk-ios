...
@implementation MSGraphDeviceCompliancePolicyRequest
...
- (NSMutableURLRequest *)update:(MSGraphDeviceCompliancePolicy *)deviceCompliancePolicy
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[deviceCompliancePolicy dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:deviceCompliancePolicy]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphDeviceCompliancePolicy alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
