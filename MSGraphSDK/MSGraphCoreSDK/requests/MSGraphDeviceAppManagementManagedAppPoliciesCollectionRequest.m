...
@implementation MSGraphDeviceAppManagementManagedAppPoliciesCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphDeviceAppManagementManagedAppPoliciesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphDeviceAppManagementManagedAppPoliciesCollectionRequest *nextRequest = [[MSGraphDeviceAppManagementManagedAppPoliciesCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
