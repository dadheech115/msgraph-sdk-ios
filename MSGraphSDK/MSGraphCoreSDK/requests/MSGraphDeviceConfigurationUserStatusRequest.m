...
@implementation MSGraphDeviceConfigurationUserStatusRequest
...
- (NSMutableURLRequest *)update:(MSGraphDeviceConfigurationUserStatus *)deviceConfigurationUserStatus
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[deviceConfigurationUserStatus dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:deviceConfigurationUserStatus]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphDeviceConfigurationUserStatus alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
