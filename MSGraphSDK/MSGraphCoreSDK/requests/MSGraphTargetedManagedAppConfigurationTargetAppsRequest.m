...
@interface MSGraphTargetedManagedAppConfigurationTargetAppsRequest()
...
@implementation MSGraphTargetedManagedAppConfigurationTargetAppsRequest
...
{
    NSDictionary *params = [[NSDictionary alloc] initWithObjectsAndKeys:[MSObject getNSJsonSerializationCompatibleValue:_apps],@"apps",nil];
