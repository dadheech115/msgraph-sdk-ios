...
typedef void (^MSGraphDefaultManagedAppProtectionAppsCollectionCompletionHandler)(MSCollection *response, MSGraphDefaultManagedAppProtectionAppsCollectionRequest *nextRequest, NSError *error);

@interface MSGraphDefaultManagedAppProtectionAppsCollectionRequest : MSCollectionRequest
