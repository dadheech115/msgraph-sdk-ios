...
- (MSGraphWorkbookRangeRequest *) requestWithOptions:(NSArray *)requestOptions
{
    return [[MSGraphWorkbookRangeRequest alloc] initWithURL:self.requestURL requestOptions:requestOptions client:self.client];
}
