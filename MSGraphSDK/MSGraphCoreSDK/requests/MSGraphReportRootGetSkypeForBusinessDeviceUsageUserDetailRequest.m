...
@interface MSGraphReportRootGetSkypeForBusinessDeviceUsageUserDetailRequest()
...
@implementation MSGraphReportRootGetSkypeForBusinessDeviceUsageUserDetailRequest
