...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphMailFolderSingleValueExtendedPropertiesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphMailFolderSingleValueExtendedPropertiesCollectionRequest *nextRequest = [[MSGraphMailFolderSingleValueExtendedPropertiesCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
