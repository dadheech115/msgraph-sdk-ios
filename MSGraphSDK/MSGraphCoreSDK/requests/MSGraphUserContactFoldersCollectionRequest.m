...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphUserContactFoldersCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphUserContactFoldersCollectionRequest *nextRequest = [[MSGraphUserContactFoldersCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
