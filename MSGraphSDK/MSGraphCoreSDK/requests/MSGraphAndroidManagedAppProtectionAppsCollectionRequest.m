...
@implementation MSGraphAndroidManagedAppProtectionAppsCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphAndroidManagedAppProtectionAppsCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphAndroidManagedAppProtectionAppsCollectionRequest *nextRequest = [[MSGraphAndroidManagedAppProtectionAppsCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
