...
@implementation MSGraphManagedAppRegistrationRequest
...
- (NSMutableURLRequest *)update:(MSGraphManagedAppRegistration *)managedAppRegistration
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[managedAppRegistration dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:managedAppRegistration]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphManagedAppRegistration alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
