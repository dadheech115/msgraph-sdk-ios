...
@implementation MSGraphGraphServiceDevicesCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphGraphServiceDevicesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphGraphServiceDevicesCollectionRequest *nextRequest = [[MSGraphGraphServiceDevicesCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
