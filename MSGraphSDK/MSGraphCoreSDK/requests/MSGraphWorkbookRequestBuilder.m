...
- (MSGraphWorkbookRequest *) requestWithOptions:(NSArray *)requestOptions
{
    return [[MSGraphWorkbookRequest alloc] initWithURL:self.requestURL requestOptions:requestOptions client:self.client];
}
