...
@implementation MSGraphWindowsInformationProtectionPolicyRequest
...
- (NSMutableURLRequest *)update:(MSGraphWindowsInformationProtectionPolicy *)windowsInformationProtectionPolicy
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[windowsInformationProtectionPolicy dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:windowsInformationProtectionPolicy]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphWindowsInformationProtectionPolicy alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
