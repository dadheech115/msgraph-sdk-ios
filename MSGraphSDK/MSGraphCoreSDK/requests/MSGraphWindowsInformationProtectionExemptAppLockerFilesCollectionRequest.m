...
@implementation MSGraphWindowsInformationProtectionExemptAppLockerFilesCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphWindowsInformationProtectionExemptAppLockerFilesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphWindowsInformationProtectionExemptAppLockerFilesCollectionRequest *nextRequest = [[MSGraphWindowsInformationProtectionExemptAppLockerFilesCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
