...
@interface MSGraphReportRootGetSkypeForBusinessOrganizerActivityUserCountsRequest()
...
@implementation MSGraphReportRootGetSkypeForBusinessOrganizerActivityUserCountsRequest
