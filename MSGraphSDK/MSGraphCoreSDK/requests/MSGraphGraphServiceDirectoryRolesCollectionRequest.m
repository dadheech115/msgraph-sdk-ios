...
@implementation MSGraphGraphServiceDirectoryRolesCollectionRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(MSGraphGraphServiceDirectoryRolesCollectionCompletionHandler)completionHandler
{
    ...
    MSURLSessionDataTask * sessionDataTask = [self collectionTaskWithRequest:[self get]
                                            ...
                                            if(!error && collectionResponse.nextLink && completionHandler){
                                                MSGraphGraphServiceDirectoryRolesCollectionRequest *nextRequest = [[MSGraphGraphServiceDirectoryRolesCollectionRequest alloc] initWithURL:collectionResponse.nextLink requestOptions:nil client:self.client];
