...
@implementation MSGraphManagedDeviceMobileAppConfigurationRequest
...
- (NSMutableURLRequest *)update:(MSGraphManagedDeviceMobileAppConfiguration *)managedDeviceMobileAppConfiguration
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[managedDeviceMobileAppConfiguration dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:managedDeviceMobileAppConfiguration]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphManagedDeviceMobileAppConfiguration alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
